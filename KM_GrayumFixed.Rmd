...
```{r}
#First, we will specify when our survival year begins. We began adding birds the week of 20 October 2021...maybe that should be the start date, instead?
start_date <- ymd("2021-10-1")

#Next, we will create a column stating when each bird was added to the study. Birds added Oct 20 2021 will be day 19, birds added in Spring (14 March) will be day 164. 
...
#Next, we will create a column "days_alive" stating how many days each bird was alive since 1 October 2021 (start time).
